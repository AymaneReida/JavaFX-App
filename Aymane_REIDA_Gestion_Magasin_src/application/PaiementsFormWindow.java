...
public class PaiementsFormWindow {
	PaiementsAddHandler handler = new PaiementsAddHandler(this);
	long idVente = 0;
	int id = 0;
	HBox boot = new HBox();
	...
	private void addNodesToWindow() {
		...
		carteRoot.getChildren().addAll(detailPaiementCarteLabel, paiementNumeroCompteBancaireLabel,
				paiementNumeroCompteBancaireTextField, paiementPayButton);
	...
	public PaiementsFormWindow(long idVente, ReglementFormWindow formReglement) {
		this.idVente = idVente;
		handler.setId_vente(idVente);
		handler.updateTotalPaye();
		handler.setFormReglement(formReglement);
		initWindow();
		addStylesToNodes();
		updateColumns();

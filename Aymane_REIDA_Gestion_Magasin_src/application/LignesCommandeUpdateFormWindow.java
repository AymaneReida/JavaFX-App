...
public class LignesCommandeUpdateFormWindow {
	LigneCommandeUpdateHandler handler = new LigneCommandeUpdateHandler(this);
	...
	private void addColumnsToTableView() {
		produitsTableView.getColumns().addAll(idProduitColumn, designationProduitColumn, qteStockProduitColumn, prixProduitAchatColumn,
				prixProduitVenteColumn);
	...
	public LignesCommandeUpdateFormWindow(Vente vente) {
		this.vente = vente;
		handler.setIdVente(vente.getId());
		initWindow();
		addStylesToNodes();
		updateColumns();
		addColumnsToTableView();
		produitsHandler.updateLigneCommandeProduitsUpdateListWindows();

...
public class ReglementSearchListWindow {
	ReglementSearchListHandler handler = null;
	...
	private void addStylesToNodes() {
		...
		ventesTableView.setOnMouseClicked(event -> {
			...
			new PaiementsListWindow(Long.valueOf(idVenteValue.getText()));
		});
	...
	public ReglementSearchListWindow(ReglementSearchListHandler handler) {
		...
		handler.updateVentesSearchListWindows();
		addNodesToPane();
		window.show();
	}
}

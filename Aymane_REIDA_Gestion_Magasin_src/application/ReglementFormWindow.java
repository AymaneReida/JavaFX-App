...
public class ReglementFormWindow {
	ReglementAddHandler handler = new ReglementAddHandler(this);
	VBox root = new VBox();
	HBox buttonsBox = new HBox();
	HBox boot = new HBox();
	Scene scene = new Scene(root);
	Stage window = new Stage();
	Label titleLabel = new Label("Nouveau règlement");
	...
	Button venteAddButton = new Button("Nouveau");
	...
	private void initWindow() {
		...
		window.setTitle("Nouveau règlement");

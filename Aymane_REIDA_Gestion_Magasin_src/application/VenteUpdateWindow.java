...
public class VenteUpdateWindow {
	VenteUpdateHandler handler = new VenteUpdateHandler(this);
	VBox root = new VBox();
	HBox buttonsBox = new HBox();
	HBox boot = new HBox();
	Scene scene = new Scene(root);
	Stage window = new Stage();
	Label titleLabel = new Label("Modifier une vente");
	...
	private void initWindow() {
		...
		window.setTitle("Modifier une vente");
	...
	private void addNodesToWindow() {
		...
		boot.getChildren().addAll(venteIdLabel, venteIdTextField, venteDateLabel, venteDateSaisieDatePicker);

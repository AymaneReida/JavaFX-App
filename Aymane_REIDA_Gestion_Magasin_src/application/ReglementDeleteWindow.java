...
public class ReglementDeleteWindow {
	ReglementDeleteHandler handler = new ReglementDeleteHandler(this);
	...
	private void addStylesToNodes() {
		...
		ventesTableView.setOnMouseClicked(event -> {
			...
			new PaiementsDeleteListWindow(Long.valueOf(idVenteValue.getText()), this);
		});
